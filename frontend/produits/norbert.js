    ...
    let request = new XMLHttpRequest();
              request.onreadystatechange = function(){
                  if (request.readyState == 4 && request.status ==200){
                      ...
                      let teddy = document.getElementById('norbert');
                      ...
                      option.innerText =data[0].colors[0];
                      option1.innerText =data[0].colors[1];
                      option2.innerText =data[0].colors[2];
                      option3.innerText =data[0].colors[3];
